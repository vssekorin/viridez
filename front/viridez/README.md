...
* [`src/viridez/`](src/viridez/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/viridez/core.cljs): contains the SPA entry point, `init`
* [`test/viridez/`](test/viridez/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `viridez` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/viridez/config.cljs) defaults to `true` in
...
```clj
(ns viridez.example
  (:require [viridez.config :as config])
